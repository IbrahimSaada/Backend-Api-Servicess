...
public class BlockService : IBlockService
{
    ...
    public async Task HandleBlockAsync(int userId, int targetUserId)
    {
        ...
        // Remove pending private questions between the two users
        var pendingPrivateQuestions = await _context.privatequestions
        ...
        {
            _context.privatequestions.RemoveRange(pendingPrivateQuestions);
        }
